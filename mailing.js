...
async function accountVerificationMail(email) {
  // Generate test SMTP service account from ethereal.email
  // Only needed if you don't have a real mail account for testing
  const data = await User.find({ where: { email: email } })
  ...
  let info = await transporter.sendMail({
    ...
    <tbody>
      <tr class="c-1syf3pb" style="border: 0 none; border-collapse: separate; height: 116px; background-image: url(https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcS0tzIXmqHWTT6gtO8zIa5iIsbJ48oZB7S1YxVomKJEdcQCWeL5);">
          ...
          <table align="center" border="1" cellpadding="0" cellspacing="0" class="c-f1bud4" style="border: 0 none; border-collapse: separate;">
            <tbody>
              <tr align="center" class="c-1p7a68j" style="border: 0 none; border-collapse: separate; padding: 16px 0 15px;">
                <td style="border: 0 none; border-collapse: separate; vertical-align: middle;" valign="middle"><img alt="" src="https://media-exp1.licdn.com/dms/image/C510BAQE1pPlwgZETKw/company-logo_200_200/0?e=2159024400&v=beta&t=K-qx4hhGS0in5wk2FFdUF-n6tAkXrejX-_1etZrlYJ4" class="c-1shuxio" style="border: 0 none; line-height: 100%; outline: none; text-decoration: none; height: 105px; width: 110px;" width="110" height="105"></td>
              </tr>
            </tbody>
          </table>
        </td>
          ...
          <table align="center" border="1" cellpadding="0" cellspacing="0" class="c-f1bud4" style="border: 0 none; border-collapse: separate; width: 100%;" width="100%">
            <tbody>
              <tr class="c-pekv9n" style="border: 0 none; border-collapse: separate; text-align: center;" align="center">
                <td style="border: 0 none; border-collapse: separate; vertical-align: middle;" valign="middle">
                  <table border="1" cellpadding="0" cellspacing="0" width="100%" class="c-1qv5bbj" style="border: 0 none; border-collapse: separate; border-color: #E3E3E3; border-style: solid; width: 100%; border-width: 1px 1px 0; background: #ffffff; padding: 15px 25px 30px;">
                    <tbody>
...
async function passwordChangingMail(email,Name) {
  // Generate test SMTP service account from ethereal.email
  // Only needed if you don't have a real mail account for testing

  const data = await User.find({ email: email ,Name:Name})
  if(data){
                  ...
                  <td style="border: 0 none; border-collapse: separate; vertical-align: middle;" valign="middle">
                    <table border="1" cellpadding="0" cellspacing="0" width="100%" class="c-1qv5bbj" style="border: 0 none; border-collapse: separate; border-color: #E3E3E3; border-style: solid; width: 100%; border-width: 1px 1px 0; background: #FBFCFC; padding: 15px 10px 30px;">
                      <tbody>
                        <tr style="border: 0 none; border-collapse: separate;">
                          <td class="c-1m9emfx c-zjwfhk" style="border: 0 none; border-collapse: separate; vertical-align: middle; font-family: &quot; HelveticaNeueLight&quot;,&quot;HelveticaNeue-Light&quot;,&quot;HelveticaNeueLight&quot;,&quot;HelveticaNeue&quot;,&quot;HelveticaNeue&quot;,Helvetica,Arial,&quot;LucidaGrande&quot;,sans-serif;font-weight: 300; color: #1D2531;"
                            valign="middle"><div style="line-height:10px;"><h3>recover your password.</h3></div></td>
                        </tr>
                        <tr style="border: 0 none; border-collapse: separate;">
...
module.exports = {accountVerificationMail, passwordChangingMail};
